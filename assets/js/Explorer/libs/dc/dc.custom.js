/* Custom mods:
 Vasco 07/18/2014: Fixing crossfilter bug of dimension filterFunction not always being available.
*/
...
dc.baseMixin = function (_chart) {
    ...
    var _filterHandler = function (dimension, filters) {
        ...
        if (filters.length === 0)
            dimension.filter(null);
        // Vasco 07/18/2014: Added extra condition for simple just 1 filter case to
        // a) improve performance
        // b) work around crossfilter bug that filterFunction is not always available for dimensions
