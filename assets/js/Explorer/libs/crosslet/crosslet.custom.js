...
// this code uses both $ and jQuery... sigh
const $ = jQuery;
...
const Crosslet = () => {
    ...
    (function (a) {
        ...
        function m(a) {
            ...
            function d(b, d, e) {
                var f = (e - d) / 6 | 0, g = d + f, h = e - 1 - f,
                    i = d + e - 1 >> 1, j = i - f, k = i + f, l = b[g],
                    m = a(l), n = b[j], o = a(n), p = b[i], q = a(p),
                    r = b[k], s = a(r), t = b[h], u = a(t), v;
        ...
        function D() {
            ...
            function q(a) {
                ...
                function X(a) {
                    var b = [], c = N, d;
                    while (c < O && a > 0) k[d = D[c]] || (b.push(e[d]), --a), c++;
                    return b
                }
                ...
                function Y(a) {
                    function K(b, c, g, i) {
                        ...
                        var o = d, p = E(n, m), t = v, u = F, w = n, y = 0,
                            z = 0, A, B, C, D, K, L;
                    ...
                    var c = {
                            ...
                            orderNatural: W,
                            size: X
                        }, d, h, j = 8, m = G(j), n = 0, o, u, v, w, F, H = x,
                        I = x, J = !0;
            ...
            function t() {
                ...
                var a = {reduce: o, reduceCount: p, reduceSum: q, value: r},
                    b, c, d, g, h = !0;
            ...
            var a = {add: p, dimension: q, groupAll: t, size: D}, e = [],
                f = 0, h = 0, j = 8, k = o(0), l = [], n = [];
    ...
    const topojson = (function () {
        ...
        function mesh(topology, o, filter) {
            ...
            if (arguments.length > 1) {
                ...
                const arc = function (i) {
                    if (i < 0) i = ~i;
                    (geomsByArc[i] || (geomsByArc[i] = [])).push(geom);
                };

                const line = function (arcs) {
                    arcs.forEach(arc);
                };

                const polygon = function (arcs) {
                    arcs.forEach(line);
                };

                const geometry = function (o) {
                    geom = o;
            ...
            div.each(function () {
                ...
                if (g.empty()) {
                    var svg = div.append("svg")
                        ...
                        .attr("id", name_id)
                    if (fill) {
                        const fill_svg = svg.append("defs").append("linearGradient").attr("id", "lg-" + id)
...
// Generated by CoffeeScript 1.6.3
    ...
    crosslet.DataStore = (function () {
        ...
        function DataStore(initData) {
            ...
            var _ref, _ref1;
            this.geoCall = initData.map.geo.topoJsonMethod;
        ...
        DataStore.prototype.loadGeo = function (getCall, geoIdField, callback, topo_objectName) {
            var _this = this;
            return this.l.load(getCall, function (t) {
                var f, _i, _len, _ref;
                if (t.arcs) {
                ...
                if (_this.bounds[0][0] > _this.bounds[1][0]) {
                    ...
                    if (_this.bounds[0][0] > 170) {
                        _this.bounds[0][0] = -180;
                    }//-=360
                    if (_this.bounds[1][0] < -170) {
                        _this.bounds[1][0] = 180;
                    } //+=360
                }
    ...
    crosslet.DataLoader = (function () {
        ...
        DataLoader.prototype.load = function (getCall, callback) {
            var urlv,
                _this = this;
            urlv = getCall.url + this.version;
            ...
            if (__indexOf.call(this.cache, urlv) >= 0) {
                ...
                if (this.status[urlv] !== "loading") {
                    ...
                    getCall.get(function (data) {
                        _this.cache[urlv] = data.data;
...
// Generated by CoffeeScript 1.6.3
    ...
    crosslet.PanelView = (function (_super) {
        ...
        PanelView.prototype.createCube = function () {
            var bName, box, brushevent, chart, d, dg, getRounder, groups,
                int, js_bName, js_box, key, keys, o, row, t1, t15, t2,
                yscale, _i, _j, _len, _len1, _ref1, _ref2, _ref3;
            this.rows = [];
            t1 = new Date().getTime();
    ...
    crosslet.BoxView = (function (_super) {
        ...
        BoxView.prototype.dataLoaded = function () {
            ...
            // 2018-12-12 AK comments because "name" is read-only
...
// Generated by CoffeeScript 1.6.3
    ...
    crosslet.MapView = (function (_super) {
        ...
        MapView.prototype.initialize = function (el, config) {
            var _this = this;
            this.config = crosslet.createConfig(crosslet.defaultConfig, config);
            this.geoCall = this.config.map.geo.topoJsonMethod;
            this.version = "1.1";
            ...
            this.map = L.map(el[0], this.config.map.leaflet).setView(this.config.map.view.center, this.config.map.view.zoom);
            ...
            return this.ds.loadGeo(this.geoCall, this.config.map.geo.id_field, function (ds) {
